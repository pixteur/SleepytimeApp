...
/// Parent-only voice setup: choose the narration engine (free device TTS, or a
/// natural cloud voice from OpenAI / ElevenLabs / Gemini), a voice, and preview
/// it. Cloud engines reuse the story keys (ElevenLabs has its own) and require
/// the same third-party-AI consent. See `docs/voice-tts.md`.
    ...
    setState(() {
      ...
      if (error != null) {
        ...
        _status =
            ...
            'key and give consent in Story AI setup first.';
        _statusOk = false;
      } else {
          ...
          child: ListView(
            ...
            children: [
              ...
              Wrap(
                spacing: 8,
                children: [
                  for (final e in VoiceEngine.values)
                    ChoiceChip(
                      label: Text(_engineLabels[e]!),
                      selected: _engine == e,
                      onSelected: _busy ? null : (_) => _onEngineChanged(e),
                    ),
                ],
              ),
              if (isCloud) ...[
                ...
                if (_engine == VoiceEngine.elevenlabs)
                  ...
                  Text(
                    'Uses your ${_engineLabels[_engine]} key from Story AI setup.',
